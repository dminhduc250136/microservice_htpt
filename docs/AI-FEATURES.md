...
> Tổng hợp toàn bộ phần ứng dụng AI cho hệ thống e-commerce microservices.
...
- **Admin**: phân tích & dự báo doanh thu (DSS) trên dashboard.
...
| 7 | Collaborative Filtering | Khách | ⬜ chưa làm | — |
| 8 | Theo dõi hành vi user | Hạ tầng | ⬜ chưa làm | — |

→ **6/8 tính năng đã hoàn thành**, bao trùm đúng các mảng của nhóm 04: RAG semantic + intent + DSS.
...
> **Bộ lọc thời gian tùy chỉnh**: dashboard hỗ trợ chọn khoảng ngày from/to (option
> "Tùy chỉnh") thay cho mốc cố định 7d/30d/90d — áp dụng cho cả chart và panel AI.
...
|---|-----------|--------------|
| 7 | Collaborative Filtering ("mua X cũng mua Y") | Phức tạp; cần tính ma trận đồng-mua. |
| 8 | Theo dõi hành vi user (view/wishlist) | Hạ tầng; cần bảng mới + thu thập data trước. |
